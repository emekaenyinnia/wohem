...
$route['fetch_events_date'] = "api/fetch_events_date";
$route['fetch_events_title'] = "api/fetch_events_title";
...
$route['meet_pastor'] = 'api/meet_pastor';
$route['testimony'] = 'api/testimoney';
$route['prayer_request'] = 'api/prayer_request';
$route['church_account'] = 'api/church_account';
$route['send_reported_issue'] ='api/ssend_reported_issue';
$route['church_branches'] = 'api/church_branches';
$route['fetch_searched_media'] = 'api/fetch_searched_media';
$route['fetch_about'] = 'api/fetch_about';
...
$route['UpdateAboutChurch'] ='about/updateAboutChurch';
...
$route['prayerRequestListing'] = 'Prayer_Requests';
$route['deletePrayerRequest/(:num)'] = 'Prayer_Requests/deletePrayerRequest/$1';

//Testimonies routes
$route['testimoniesListing'] = 'Testimonies';
$route['deleteTestimony/(:num)'] = 'Testimonies/deleteTestimony/$1';

//Meeting routes
$route['meetingsListing'] = 'Meetings';
$route['deleteMeeting/(:num)'] = 'Meetings/deleteMeeting/$1';



// Church account route 
$route['churchaccountsListing'] = 'Church_Account';
$route['newChurchAccount'] = 'Church_Account/newChurchAccount';
$route['savenewchurchaccount'] = 'Church_Account/savenewchurchaccount';
$route['deleteChurchAccount/(:num)'] = 'Church_Account/deleteChurchAccount/$1';
...
// route for report 
$route['reportsListing'] = 'Reports';
$route['deleteReport/(:num)'] = 'reports/deleteReport/$1';
