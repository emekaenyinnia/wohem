...
<body class="light layout-fixed theme-blue">
  ...
  <nav class="navbar">
      <div class="container-fluid">
          <div class="navbar-header">
              ...
              <a class="navbar-brand" href="<?php echo site_url(); ?>">WOHEM - ADMIN</a>
          </div>
  ...
  <section>
      ...
      <aside id="leftsidebar" class="sidebar">
          ...
          <div class="menu">
              <ul class="list">
                <li class="header">MAIN NAVIGATION</li>
                  ...
                  <li <?php if (strpos($url,'testimoniesListing') !== false ){ ?> class="active" <?php } ?>>
                      <a href="#Testimonies"  data-toggle="collapse" class="menu-toggle" aria-expanded="false">
                      ...
                      <ul class="ml-menu">
                          <li>
                              <a href="<?php echo base_url(); ?>testimoniesListing" title="testimoniesListing">Listing</a>
                          </li>
                      </ul>
                  </li>
                  <li <?php if (strpos($url,'prayerRequestListing') !== false ){ ?> class="active" <?php } ?>>
                      <a href="#Prayer_Requests"  data-toggle="collapse" class="menu-toggle" aria-expanded="false">
                          <i class="material-icons">mail</i>
                          <span>Prayer Requests</span>
                      </a>
                      <ul class="ml-menu">
                          <li>
                              <a href="<?php echo base_url(); ?>prayerRequestListing" title="prayerRequestListing">Listing</a>
                          </li>
                      </ul>
                  </li>
                  <li <?php if (strpos($url,'meetingsListing') !== false ){ ?> class="active" <?php } ?>>
                      <a href="#Meetings"  data-toggle="collapse" class="menu-toggle" aria-expanded="false">
                          <i class="material-icons">schedule </i>
                          <span>Meetings</span>
                      </a>
                      <ul class="ml-menu">
                          <li>
                              <a href="<?php echo base_url(); ?>meetingsListing" title="meetingsListing">Listing</a>
                          </li>
                      </ul>
                  </li>
                  ...
                  <li <?php if (strpos($url,'churchaccountsListing') !== false ){ ?> class="active" <?php } ?>>
                      <a href="#churchaccount"  data-toggle="collapse" class="menu-toggle" aria-expanded="false">
                          <i class="material-icons">account_balance_wallet </i>
                          <span>Church Accounts</span>
                      </a>
                      <ul class="ml-menu">
                          <li>
                              <a href="<?php echo base_url(); ?>churchaccountsListing" title="churchaccountsListing">Listing</a>
                          </li>
                          <li>
                              <a href="<?php echo base_url(); ?>newChurchAccount" title="newChurchAccount">Add New</a>
                          </li>
                      </ul>
                  </li>
                  ...
                  <li <?php if (strpos($url,'reportsListing') !== false){ ?> class="active" <?php } ?>>
                      <a href="<?php echo base_url(); ?>Reports" title="reportsListing">
                  ...
                  <li <?php if (strpos($url,'About') !== false){ ?> class="active" <?php } ?>>
                      <a href="<?php echo base_url(); ?>About" title="About">
          ...
          <div class="legal">
              <div class="copyright">
                  &copy; <?php echo date('Y'); ?> <a href="javascript:void(0);">WOHEM - Admin</a>.
              </div>
