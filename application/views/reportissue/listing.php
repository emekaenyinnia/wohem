                          ...
                          <div style="overflow-x:auto;">
                            <table id="categories-table" class="table table-responsive table-bordered table-striped table-hover exportable">
                              ...
                              <tbody>
                                  <?php
                                  $count=1;
                                  forEach($report_issue as $record){
                                  ?>
                                  <tr>
                                  <td><?php echo $count; ?></td>
                                    ...
                                    <td class="text-center">
                                        <button onclick="delete_item(event)" data-type="report_issue" data-id="<?php echo $record->id; ?>" type="button" class="btn btn-danger btn-lg m-l-15 waves-effect" style="float: none;">
                                         <i style="color:white;margin-bottom:5px;"  class="material-icons list-icon" data-type="report_issue" data-id="<?php echo $record->id; ?>">delete</i>
                                        </button>
                                      </div>
                                    </td>
                                   </tr>
