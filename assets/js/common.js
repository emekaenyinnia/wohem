...
function delete_item(e){
  ...
  switch(type){
    ...
    break;
    case 'churchaccount':
      var msg = 'You want to delete this account';
      url = baseURL+'deleteChurchAccount/'+id;
    break;
    case 'prayer_request':
      var msg = 'You want to delete this prayer request';
      url = baseURL+'deletePrayerRequest/'+id;
   break;
   case 'report_issue':
    var msg = 'You want to delete this issue reported ';
 ...
 break;
 case 'meeting':
  var msg = 'You want to delete this meeting';
  url = baseURL+'deleteMeeting/'+id;
break;
    case 'video':
